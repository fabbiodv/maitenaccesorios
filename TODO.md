...
- [] Configurar admin en subdominio/path (admin.maitenaccesorios.com.ar o /admin)
- [] Configurar backup automático de PostgreSQL
- [] Configurar DNS para maitenaccesorios.com.ar apuntando al VPS
- [] Deploy inicial y pruebas de todo el sistema

## PRIORIDAD BAJA (mejoras)

- [] Configurar monitoreo básico y logs
